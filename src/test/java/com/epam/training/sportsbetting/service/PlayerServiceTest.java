...
class PlayerServiceTest {
    ...
    void shouldProcessPlayerBalance() throws Exception {
        ...
        assertEquals(NEW_BALANCE, player.getBalance());
    }
    ...
    void shouldDisplayMessages() throws Exception {
        ...
        verify(view, times(1)).displayList(any());
        verify(view, times(1)).displayFormattedMessage(anyString(), anyString());
    }
    ...
    void shouldDisplayOutcomes() throws Exception {
        ...
        verify(sportEventService, times(1)).showOutcomes(any(), any());
    }
    ...
    void shouldDisplayNoEventsMessage() throws Exception {
        ...
        verify(view, times(1)).displayMessage(NO_OUTCOME_ODDS);
    }
